...
@WebServlet("/UnsubscribeShareFrom")
public class UnsubscribeShareFrom extends HttpServlet {
    @Override
    protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (type==1){
            ...
            if (flag){
                resp.sendRedirect(req.getContextPath()+"/Sub_page.jsp?message=Succeefully");
            }else {
